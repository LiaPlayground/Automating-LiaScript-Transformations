...
![GitHub Workflows Overview](media/actions.png)
...
1. **Repository Checkout and Environment Setup:**
   ...
   ![Repository Checkout and Node.js Setup](media/action-1.png)
...
2. **Installing and Running the Exporter:**
   ...
   ![Exporter Installation and Conversion Steps](media/action-2.png)
...
3. **Release Management:**
   ...
   - **Asset Uploads:** Each generated file (PDF, SCORM, IMS) is uploaded as a release asset.
    ...
    ![Release Management and Asset Uploads](media/action-3.png)
...
![Show Release](media/home.png)

You can download and share these files with others.

![GitHub Release with Generated Assets](media/assets.png)
